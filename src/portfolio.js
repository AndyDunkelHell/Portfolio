...
const about = {
  ...
  description:
    "I am Andres Gonzalez, 24 years old. I'm currently in Leipzig and studying a Master's degree in Medical Informatics at the University of Leipzig. In the first two years of my life in Germany I was first in Cologne as an exchange student, then I studied for a year in a Studienkolleg in Geilenkirchen. During the following years I completed my Bachelor's degree in Biomedical Engineering at the FH Aachen. I come from Venezuela and am here in Germany so that I can make my dream come true, namely to help millions of people in the future with my developments.",
