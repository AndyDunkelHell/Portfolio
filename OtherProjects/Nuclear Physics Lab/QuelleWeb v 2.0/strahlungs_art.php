  ...
  <tr>
   ...
   <?php 
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<td>" . $row['id'] . "</td>";
            echo "<td>" . $row['typ'] . "</td>";
            echo "<td><form action='nuklid.php' method='POST'> <button type='submit' name='nuklid' value='". $row['nuklid'] ."' class='btn-link'>" . $row['nuklid'] . "</button>
		</form></td>";
            
            echo "<td><form action='aktuelle_akt.php' method='POST'> <button type='submit' name='preparate_nr' value='".$row['preparate_nr_art']."' class='btn-link'>" . $row['preparate_nr_art'] . "</button>
		</form></td>";
            echo "</tr>";
