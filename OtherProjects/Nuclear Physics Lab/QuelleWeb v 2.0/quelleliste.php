...
<body>
	...
	<form action="quelleliste.php" method="post"> 
  ...
  <tr>
   ...
   <?php 
        ...
        while ($row = mysqli_fetch_assoc($result)){
            ...
            echo "<td><form action='nuklid.php' method='POST'> <button type='submit' name='nuklid' value='".$row['nuklide_art']."' class='btn-link'>" . $row['nuklide_art'] . "</button>
		</form></td>";
